...
#	$debug_flag = 1 if ($start == 149420331);
	...
	for my $overlapped_ensg (keys %tmp_hash) {
	  TYPELOOP:	    for my $feature_type ("tRNA","miRNA","miRNA-proximal","CDS","3utr","5utr","5ss","3ss","proxintron","distintron","noncoding_exon","noncoding_5ss","noncoding_3ss","noncoding_proxintron","noncoding_distintron") {
	...
	my $final_feature_ensg = "NA";
      ...
      TYPELOOPB:           for my $feature_type ("tRNA","miRNA","CDS","3utr","5utr","noncoding_exon","miRNA-proximal","5ss","noncoding_5ss","3ss","noncoding_3ss","proxintron","noncoding_proxintron","distintron","noncoding_distintron") {
